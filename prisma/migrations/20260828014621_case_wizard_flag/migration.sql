...
INSERT INTO "new_Module" ("dayId", "hasDiagnostic", "hasPentagramWizard", "hasTaskWizard", "hasWizard", "id", "order", "pdfUrl", "title") SELECT "dayId", "hasDiagnostic", "hasPentagramWizard", "hasTaskWizard", "hasWizard", "id", "order", "pdfUrl", "title" FROM "Module";
DROP TABLE "Module";
