...
// --- Задания-тренажёры без рецензии (М2 Pentagram, М3 Сборка кейса) ---
// Рецензии нет, ИИ не ставит балл — гейт локальный. Балл в компоненте «работы»
// фиксированный за сам факт зачёта, чтобы модуль был симметричен остальным.
export const NO_REVIEW_FIXED_SCORE = 5;
