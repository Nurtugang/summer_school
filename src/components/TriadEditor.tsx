      ...
      {readOnly ? (
        ...
        <Panel className="flex flex-col gap-2 bg-mint">
          ...
          <p className="text-[14px] text-ink">
            Триада «Результат → Проверка → Активность» — это конструктивное согласование Биггса
            (constructive alignment): занятие работает, только если все три части ведут к одному и тому
            же — студент понимает, ЧТО он должен уметь после занятия (Результат), КАК вы это увидите
            (Проверка), и ЧЕМ студенты реально занимаются на занятии, чтобы туда прийти (Активность).
            Рассогласование между ними — самая частая скрытая причина, почему занятие «не сработало»,
            даже когда каждый пункт по отдельности выглядит нормально.
          </p>
          <p className="text-[14px] text-ink">
            ИИ здесь не пишет триаду за вас — вы собираете её сами. Дальше «Проверка на
            согласованность» задаст 2-3 въедливых вопроса именно по вашей формулировке (не общих), и
            ваша задача — либо поправить триаду, либо аргументированно ответить на вопрос. Так вы сами
            находите разрывы в логике занятия, а не получаете готовый чужой ответ.
          </p>
          <p className="text-[14px] text-muted">
            Порядок: заполните три поля → «Проверка на согласованность» → поправьте текст или ответьте
            на вопросы (можно и то, и другое) → по желанию «Проверь меня» — ИИ скажет, закрыли ли вы
            разрыв → «Отправить на рецензию» коллегам.
          </p>
        </Panel>
      )}
